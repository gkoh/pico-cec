...
// For timer support:
// CONFIG_ESP_TIMER_SUPPORTS_ISR_DISPATCH_METHOD=y  // sdkconfig (not needed now that we are not using the gptimer?)
...
/*
time_us_64: Return the current 64 bit timestamp value in microseconds for the default timer instance.
...
*/
/*
uint64_t time_us_64(): Return the current 64 bit timestamp value in microseconds for the default timer instance.
*/  
